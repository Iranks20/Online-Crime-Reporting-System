...
def evidence_upload_location(instance, filename):
    return 'anonymous/%s/%s' % (t, filename)
...
class AnonymousTip(models.Model):
    ...
    userid = models.ForeignKey(AnonymousUser, null=True, blank=True, on_delete=models.SET_NULL)  # Add on_delete
...
class Evidence(models.Model):
    ...
    anonymous_tip = models.ForeignKey(AnonymousTip, null=True, blank=True, on_delete=models.CASCADE)  # Add on_delete
